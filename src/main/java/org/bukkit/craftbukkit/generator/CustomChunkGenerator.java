...
public class CustomChunkGenerator extends InternalChunkGenerator {
    ...
    public CustomChunkGenerator(ServerWorld world, net.minecraft.world.gen.chunk.ChunkGenerator delegate, ChunkGenerator generator) {
        super(delegate.getBiomeSource(), delegate.getStructuresConfig());
    ...
    @Override
    public void populateBiomes(Registry<net.minecraft.world.biome.Biome> iregistry, Chunk ichunkaccess) {
    ...
    @Override
    public void addStructureReferences(StructureWorldAccess generatoraccessseed, StructureAccessor structuremanager, Chunk ichunkaccess) {
        delegate.addStructureReferences(generatoraccessseed, structuremanager, ichunkaccess);
    }
    ...
    @Override
    public void setStructureStarts(DynamicRegistryManager iregistrycustom, StructureAccessor structuremanager, Chunk ichunkaccess, StructureManager definedstructuremanager, long i) {
        if (generator.shouldGenerateStructures()) {
            ...
            delegate.setStructureStarts(iregistrycustom, structuremanager, ichunkaccess, definedstructuremanager, i);
        }
