...
public class CraftBlock implements Block {
    ...
    public World getWorld() {
        return world.getMinecraftWorld().getCraftWorld();
    }
    ...
    public boolean setTypeAndData(final net.minecraft.block.BlockState blockData, final boolean applyPhysics) {
        ...
        if (applyPhysics) {
            ...
            if (success) {
                world.getMinecraftWorld().updateListeners(
                        position,
                        old,
                        blockData,
                        3
    ...
    public static Biome biomeBaseToBiome(net.minecraft.util.registry.Registry<net.minecraft.world.biome.Biome> registry, net.minecraft.world.biome.Biome base) {
        ...
        return Registry.BIOME.get(CraftNamespacedKey.fromMinecraft(registry.getId(base)));
    }
    ...
    public boolean applyBoneMeal(BlockFace face) {
        ...
        ItemUsageContext context = new ItemUsageContext(getCraftWorld().getHandle(), null, Hand.MAIN_HAND, Items.BONE_MEAL.getDefaultStack(), new BlockHitResult(Vec3d.ZERO, direction, getPosition(), false));

        return BoneMealItem.applyBonemeal(context) == ActionResult.SUCCESS;
    }
    ...
    public RayTraceResult rayTrace(Location start, Vector direction, double maxDistance, FluidCollisionMode fluidCollisionMode) {
        ...
        HitResult nmsHitResult = world.rayTraceBlock(new RaycastContext(startPos, endPos, RaycastContext.ShapeType.OUTLINE, CraftFluidCollisionMode.toNMS(fluidCollisionMode), null), position);
